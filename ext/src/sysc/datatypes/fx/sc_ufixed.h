...
public:
    ...
    explicit sc_ufixed( sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );
    explicit sc_ufixed( const sc_fxcast_switch&,
            sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );

#define DECL_CTORS_T_A(tp)                                                    \
             sc_ufixed( tp, sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );\
             sc_ufixed( tp, const sc_fxcast_switch&,                          \
                        sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );

#define DECL_CTORS_T_B(tp)                                                    \
    explicit sc_ufixed( tp, sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );\
             sc_ufixed( tp, const sc_fxcast_switch&,                          \
                        sc_fxnum_observer* observer_ = SC_UFXNUM_OBSERVER );
...
public:
    ...
    explicit sc_ufixed_fast( sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );
    explicit sc_ufixed_fast( const sc_fxcast_switch&,
                sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );

#define DECL_CTORS_T_A(tp)                                                    \
             sc_ufixed_fast( tp, sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER ); \
             sc_ufixed_fast( tp, const sc_fxcast_switch&,                     \
                             sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );

#define DECL_CTORS_T_B(tp)                                                    \
    explicit sc_ufixed_fast( tp, sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );               \
             sc_ufixed_fast( tp, const sc_fxcast_switch&,                     \
                sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );
...
#undef DECL_CTORS_T_B
    ...
    sc_ufixed_fast( const sc_ufixed_fast<W,I,Q,O,N>& a,
            sc_fxnum_fast_observer* observer_ = SC_UFXNUM_FAST_OBSERVER );
...
sc_ufixed_fast<W,I,Q,O,N>::sc_ufixed_fast( const sc_ufixed_fast<W,I,Q,O,N>& a, sc_fxnum_fast_observer* observer_ )
: sc_ufix_fast( a, W, I, Q, O, N, observer_ )
{}
