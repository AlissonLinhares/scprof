...
public:
    ...
    explicit sc_fixed( sc_fxnum_observer* observer_= SC_FXNUM_OBSERVER );
    explicit sc_fixed( const sc_fxcast_switch&,
                sc_fxnum_observer* observer_ = SC_FXNUM_OBSERVER );

#define DECL_CTORS_T_A(tp)                                                    \
             sc_fixed( tp, sc_fxnum_observer* observer_= SC_FXNUM_OBSERVER ); \
             sc_fixed( tp, const sc_fxcast_switch&,                           \
                sc_fxnum_observer* observer_= SC_FXNUM_OBSERVER );

#define DECL_CTORS_T_B(tp)                                                    \
    explicit sc_fixed( tp, sc_fxnum_observer* observer_ = SC_FXNUM_OBSERVER );\
             sc_fixed( tp, const sc_fxcast_switch&,                           \
                sc_fxnum_observer* observer_= SC_FXNUM_OBSERVER );
...
#undef DECL_CTORS_T_B
    ...
    sc_fixed( const sc_fixed<W,I,Q,O,N>& fix,
       sc_fxnum_observer* observer_= SC_FXNUM_OBSERVER );
...
public:
    ...
    explicit sc_fixed_fast( sc_fxnum_fast_observer*
                               observer_ = SC_FXNUM_FAST_OBSERVER );
    explicit sc_fixed_fast( const sc_fxcast_switch&,
                sc_fxnum_fast_observer* observer_ = SC_FXNUM_FAST_OBSERVER );

#define DECL_CTORS_T_A(tp)                                                    \
             sc_fixed_fast( tp, sc_fxnum_fast_observer*                       \
                                   observer_ = SC_FXNUM_FAST_OBSERVER );      \
             sc_fixed_fast( tp, const sc_fxcast_switch&,                      \
                sc_fxnum_fast_observer* observer_ = SC_FXNUM_FAST_OBSERVER );

#define DECL_CTORS_T_B(tp)                                                    \
    explicit sc_fixed_fast( tp,                                               \
                sc_fxnum_fast_observer* observer_ = SC_FXNUM_FAST_OBSERVER ); \
             sc_fixed_fast( tp, const sc_fxcast_switch&,                      \
                sc_fxnum_fast_observer* observer_ = SC_FXNUM_FAST_OBSERVER );
...
#undef DECL_CTORS_T_B
    ...
    // copy constructor
    sc_fixed_fast( const sc_fixed_fast<W,I,Q,O,N>& fix,
                  sc_fxnum_fast_observer* observer_ = SC_FXNUM_FAST_OBSERVER );
...
template<int W, int I, sc_q_mode Q, sc_o_mode O, int N>
inline
sc_fixed<W,I,Q,O,N>::sc_fixed(const sc_fixed<W,I,Q,O,N>& a, sc_fxnum_observer* observer_)
: sc_fix( a, W, I, Q, O, N, observer_ )
{}
...
template<int W, int I, sc_q_mode Q, sc_o_mode O, int N>
inline
sc_fixed_fast<W,I,Q,O,N>::sc_fixed_fast( const sc_fixed_fast<W,I,Q,O,N>& a, sc_fxnum_fast_observer* observer_ )
: sc_fix_fast( a, W, I, Q, O, N, observer_ )
{}
